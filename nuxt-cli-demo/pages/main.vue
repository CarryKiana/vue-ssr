  ...
  <div class="main-page">
    ...
    <div class="data-show">
      <div class="item">
        ...
        <div class="item-data">{{detail.auditingMaterialCount}}</div>
      </div>
      <div class="item">
        <div class="item-title">审核不通过素材</div>
        <div class="item-data">{{detail.auditNotPassMaterialCount}}</div>
      </div>
      <div class="item">
...
import doubleLineChart from "@/components/operatedoublelinechart";
